        ...
        <div className="">
          ...
          <div className="flex flex-col md:flex-row justify-center md:justify-evenly md:space-x-6">
            <div className="md:w-96 flex-1 md:flex-initial h-full rounded overflow-hidden shadow-md shadow-black/50 my-4">
              <img className="w-full h-44 bg-black dark:bg-neutral-900" src="/test-website-2/next.svg" alt="Sunset in the mountains" />
              <div className="p-4 mt-4">
                <div className="font-bold text-xl text-center">Our Story</div>
                <div className="text-base whitespace-pre-line text-center">
                  {`
Welcome to Wolfman Repairs, where passion meets craftsmanship. Founded in late 2022, Wolfman Repairs was born out of a love for retro video games and a desire to breathe new life into classic consoles.
...
Thank you for being a part of the Wolfman Repairs family.
              ...
              <button className="w-full text-center bg-gray-200 hover:bg-gray-300 py-2">
            ...
            <div className="md:w-96 flex-1 md:flex-initial h-full rounded overflow-hidden shadow-md shadow-black/50 my-4">
              <img className="w-full h-44 bg-black dark:bg-neutral-900" src="/test-website-2/next.svg" alt="Sunset in the mountains" />
              <div className="p-4 mt-4">
                <div className="font-bold text-xl text-center">Our Team</div>
                <div className="text-base whitespace-pre-line text-center">
                  {`
The driving force behind Wolfman Repairs: the one-man show known simply as the Wolfman. With a passion for retro gaming and a knack for fixing things, the Wolfman is the heart and soul of our operation.
...
As the sole member of the Wolfman Repairs team, he wears many hats: technician, curator, marketer, and everything in between. From scouring flea markets for hidden gems to meticulously restoring consoles in his dungeon, the Wolfman's dedication to his craft knows no bounds.
